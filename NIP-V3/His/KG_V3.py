...
# pos = nx.spring_layout(G, k=15.5, iterations=1000)  # k值控制节点间距，iterations控制迭代次数
...
for node, (x, y) in pos.items():
    plt.text(x, y, labels[node], fontsize=9, fontfamily="sans-serif", verticalalignment='center',
...
legend = plt.legend(
    ...
    categories, title="Categories", loc='upper left', bbox_to_anchor=(1, 1)
)
